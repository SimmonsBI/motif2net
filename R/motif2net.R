...
motif2net <- function(target_motif_distribution, distribution_type, rows = NULL, columns = NULL, connectance = NULL, steps = 1000, iterations_at_each_temp = 1, alpha = 0.99){
  # argument checks
  if(!(inherits(target_motif_distribution, "numeric") | inherits(target_motif_distribution, "integer"))){stop("'target_motif_distribution' must be a numeric or integer vector containing raw or normalised motif frequencies")}
